...
db=mysql.connector.connect(user='root',password='',port=3307,database='obiseity')
cur=db.cursor()
app=Flask(__name__)
...
def modelselection():
    global lraccuracy, DTaccuracy, RFaccuracy
    if request.method=='POST':
...
def graph():
    ...
    data = {'Logistic Regression': lraccuracy, 'Decision Tree': DTaccuracy, 'Random Forest': RFaccuracy }
    ...
    return redirect('modelselection')
...
def prediction():
    ...
    if request.method=='POST':
        ...
        if pred[0]== 0:
            msg = '<span style = color:blue;>Insufitient Weight</span></b>'
        elif pred[0]== 1:
            msg = '<span style = color:blue;>Normal Weight</span></b>'
        elif pred[0]== 2:
            msg = '<span style = color:blue;>Obesity Type - 1</span></b>'
        elif pred[0]== 3:
            msg = '<span style = color:blue;>Obesity Type - 2</span></b>'
        elif pred[0] == 4:
            msg = '<span style = color:blue;>Obesity Type - 3</span></b>'
        elif pred[0] == 5:
            msg = '<span style = color:blue;>OverWeight Level-1</span></b>'
        else:
            msg = '<span style = color:blue;>OverWeight Level - 2</span></b>'
